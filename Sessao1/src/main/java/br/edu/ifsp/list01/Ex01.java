...
/*
    ...
    Faça um programa em que o usuário informe a quantidade positiva e não nula de livros seja impressa qual o melhor plano de pagamento.
...
class Ex01 {
    ...
    String compute(int qtdLivros) {
        ...
        if (precoA > precoB) return "Critério B";
